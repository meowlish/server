...
} from '@core/exam/app/commands/staff/exam.create-exam.command';
import {
	CreateQuestionCommand,
	CreateQuestionCommandPayload,
} from '@core/exam/app/commands/staff/exam.create-question.command';
import {
	CreateSectionCommand,
	CreateSectionCommandPayload,
} from '@core/exam/app/commands/staff/exam.create-section.command';
import {
	DeleteExamCommand,
	DeleteExamCommandPayload,
} from '@core/exam/app/commands/staff/exam.delete-exam.command';
import {
	DeleteQuestionCommand,
	DeleteQuestionCommandPayload,
} from '@core/exam/app/commands/staff/exam.delete-question.command';
import {
	DeleteSectionCommand,
	DeleteSectionCommandPayload,
} from '@core/exam/app/commands/staff/exam.delete-section.command';
import {
	MoveQuestionCommand,
	MoveQuestionCommandPayload,
} from '@core/exam/app/commands/staff/exam.move-question.command';
import {
	MoveSectionCommand,
	MoveSectionCommandPayload,
} from '@core/exam/app/commands/staff/exam.move-section.command';
import {
	ReviewExamCommand,
	ReviewExamCommandPayload,
} from '@core/exam/app/commands/staff/exam.review-exam.command';
import {
	UpdateExamCommand,
	UpdateExamCommandPayload,
} from '@core/exam/app/commands/staff/exam.update-exam.command';
import {
	UpdateQuestionCommand,
	UpdateQuestionCommandPayload,
} from '@core/exam/app/commands/staff/exam.update-question.command';
import {
	UpdateSectionCommand,
	UpdateSectionCommandPayload,
} from '@core/exam/app/commands/staff/exam.update-section.command';
import { Controller } from '@nestjs/common';
import { CommandBus } from '@nestjs/cqrs';

import {
	ExamManagementServiceController,
	ExamManagementServiceControllerMethods,
...
@ExamManagementServiceControllerMethods()
@Controller()
export class ExamController implements ExamManagementServiceController {
