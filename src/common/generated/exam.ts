...
export interface ExamManagementServiceController {
	...
	deleteExam(
		request: DeleteExamDto,
		metadata?: Metadata,
	): Promise<Empty> | Observable<Empty> | Empty;

	deleteSection(
		request: DeleteSectionDto,
		metadata?: Metadata,
	): Promise<Empty> | Observable<Empty> | Empty;

	deleteQuestion(
		request: DeleteQuestionDto,
		metadata?: Metadata,
	): Promise<Empty> | Observable<Empty> | Empty;

	moveSection(
		request: MoveSectionDto,
		metadata?: Metadata,
	): Promise<Empty> | Observable<Empty> | Empty;

	moveQuestion(
		request: MoveQuestionDto,
		metadata?: Metadata,
	): Promise<Empty> | Observable<Empty> | Empty;

	reviewExam(
		request: ReviewExamDto,
		metadata?: Metadata,
	): Promise<Empty> | Observable<Empty> | Empty;
}
...
export function ExamManagementServiceControllerMethods() {
	return function (constructor: Function) {
		...
		for (const method of grpcMethods) {
			...
			GrpcMethod('ExamManagementService', method)(
		...
		for (const method of grpcStreamMethods) {
			const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
			GrpcStreamMethod('ExamManagementService', method)(
				constructor.prototype[method],
				method,
				descriptor,
			);
